...
.then(contenido => {
    ...
    const info = JSON.parse(contenido) // Pasar a Object
    console.log(info)
    ...
    fs.promises.writeFile('package.json.coder', JSON.stringify(packageJsonObj, null, 2)) // Pasar packageJsonObj a string
